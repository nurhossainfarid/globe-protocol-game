...
const SelectCharacter = () => {
  ...
  return (
    ...
    >
      ...
      >
        {character === "chr" && (
          <Box component="img" sx={{ width: 250, height: 550 }} src={Char} />
        )}
        {character === "chr2" && (
          <Box component="img" sx={{ width: 250, height: 550 }} src={Char2} />
        )}
        {character === "chr3" && (
          <Box component="img" sx={{ width: 250, height: 550 }} src={Char3} />
        )}
        <Box
          component="div"
