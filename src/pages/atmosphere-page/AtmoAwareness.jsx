...
const atmosphereData = [
  ...
  },
  {
    ...
    nasaMonitoring:
      "NASA uses satellites like ICESat-2, GRACE-FO, and Jason-3 to monitor sea level rise, providing data on ice sheet melting, ocean surface height, and water distribution. A new instrument, the Sentinel-6 Michael Freilich, helps scientists study changes in sea level with high precision. By analyzing this data alongside other climate indicators, scientists can better understand the causes and impacts of rising sea levels on coastal areas and global ecosystems.",
    whyUrl: "https://i.ibb.co.com/ygBDyRS/sea-Level-why.webp",
    howUrl: "https://i.ibb.co.com/zQf9BjR/sea-Level-how.webp",
    solutionUrl: "https://i.ibb.co.com/YQ6LPBq/sea-Level-solution.webp",
    imgWidth: "250px",
    additionalResources: ["https://climatekids.nasa.gov/air-pollution/"],
    relatedMission: [
      {
      ...
      {
        title: "Tempo",
        url: "https://science.nasa.gov/mission/tempo/",
        img: "https://climatekids.nasa.gov/resources/featured/missions/TEMPO.png",
      },
      {
        title: "OCO-2",
        url: "https://science.nasa.gov/mission/oco-2/",
  ...
  },
  {
    ...
    nasaMonitoring:
      "NASA uses satellites like Aqua, Terra, and Suomi-NPP to monitor heat waves, providing data on surface temperatures, land heat absorption, and atmospheric conditions. A new instrument, the ECOSTRESS (Ecosystem Spaceborne Thermal Radiometer Experiment on Space Station), helps scientists study plant water use and land surface temperature during heat waves. By analyzing this data alongside other climate indicators, scientists can better understand the causes, intensity, and effects of heat waves on ecosystems, agriculture, and human health.",
    whyUrl: "https://i.ibb.co.com/NnJ9p6G/heat-why.webp",
    howUrl: "https://i.ibb.co.com/SsyXKjm/heat-how.webp",
    solutionUrl: "https://i.ibb.co.com/wBJ3db6/heat-solution.webp",
    imgWidth: "250px",
    additionalResources: ["https://climatekids.nasa.gov/air-pollution/"],
    relatedMission: [
      {
